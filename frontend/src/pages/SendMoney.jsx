                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            class="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white">Initate Transfer</button>
                    </div>
                </div>
            </div>
        </div>
